...
// Al final de loadAll(), antes del if (currentUser)
do <div style="background:var(--bg2);border-radius:14px;padding:28px;width:340px;max-width:94vw;box-shadow:0 8px 32px rgba(0,0,0,.18)">
      <div style="font-weight:600;font-size:15px;margin-bottom:18px;color:var(--text)">Exportar Excel</div>
      <div style="display:flex;flex-direction:column;gap:12px">
        <label style="font-size:12px;color:var(--text2);display:flex;flex-direction:column;gap:4px">
          Desde
          <input type="date" id="exp-desde" style="padding:8px 10px;border-radius:8px;border:1px solid var(--b);background:var(--bg2);color:var(--text);font-size:13px">
        </label>
        <label style="font-size:12px;color:var(--text2);display:flex;flex-direction:column;gap:4px">
          Hasta
          <input type="date" id="exp-hasta" style="padding:8px 10px;border-radius:8px;border:1px solid var(--b);background:var(--bg2);color:var(--text);font-size:13px">
        </label>
        <div style="font-size:11px;color:var(--text3)">Deja vacío para exportar todos los registros.</div>
      </div>
      <div style="display:flex;gap:8px;margin-top:20px">
        <button onclick="closeExportModal()" style="flex:1;padding:9px;border-radius:8px;border:1px solid var(--b);background:transparent;color:var(--text2);font-size:13px;cursor:pointer">Cancelar</button>
        <button onclick="doExportExcel()" style="flex:1;padding:9px;border-radius:8px;border:none;background:var(--accent);color:#fff;font-size:13px;font-weight:600;cursor:pointer">Descargar</button>
      </div>
    </div>
  </div>
`);
